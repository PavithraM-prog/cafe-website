...
import { Trash2, ShoppingBag, Plus, Minus, CreditCard, Tag, ArrowRight, MapPin, Phone, AlertCircle, Loader2 } from "lucide-react";
...
export default function CartPage() {
  ...
  // Prefill phone and address if user is logged in
  useEffect(() => {
    if (user) {
  ...
  const handlePlaceOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.order) {
        clearCart();
        // Redirect to PhonePe sandbox payment gateway page
              ...
              <div className="border border-borderColor bg-cardBg p-6 rounded-xl shadow-sm space-y-4">
                ...
                <div className="rounded-lg bg-secondary/50 p-3 flex items-start space-x-2 text-[10px] text-textMuted border border-borderColor/40">
                  ...
                  <p className="leading-relaxed">
                    <strong>PhonePe Sandbox:</strong> Clicking &quot;Proceed to Payment&quot; will create your order and redirect you to the PhonePe demo payment gateway.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-secondary/40 p-4 flex items-start space-x-2.5 text-[10px] text-textMuted border border-borderColor/40">
                  ...
                  <p className="leading-relaxed font-light font-medium">
                    <strong>PhonePe Sandbox Gateway:</strong> You will be redirected to a mock PhonePe payment screen to complete your transaction securely (project demo mode).
                  </p>
                </div>
